...
public class ImportCodeListFromCSVTest extends AbstractCsvImportTaskTest {
	...
	private static final String PATH_BOM = System.getProperty("user.dir") + "/src/test/resources/scheduler/task/impl/importCodeListTestFileCreateWithBom.csv";
	...
	@Test
	public void importFromCsvFileWithBom() {
		IdmAttachmentDto attachment = createAttachment(PATH_BOM, "importCodeListTestFileCreateWithBom.csv");
